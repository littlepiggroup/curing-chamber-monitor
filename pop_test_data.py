...
def populate():
    ...
    sample1 = Sample(project=project1, company=building_company_1, instance_id='1', contract=contract,
                     name="混凝土试件", regular=False, num='10',
                     hnt_yhtj='标准养护', exam_result=120)
    sample1.save()
