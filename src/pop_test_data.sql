...
INSERT INTO ccmapp_video (save_abs_path, url_path, camera_id)
VALUES ('temp','temp', 1);
...
insert into ccmapp_sensor (device_number, sensor_type, project_id, name, decription)
...
VALUES (3, 'CREATED', NOW(), NOW(), 1,1,1,'XiaoCui', 'XiaoMa');

insert into ccmapp_humidityalert
(alert_type, status, create_time, update_time, company_id, project_id, sensor_id, created_by,updated_by,
description, comment)
VALUES (4, 'CREATED', NOW(), NOW(), 1,1,1,'XiaoCui', 'XiaoMa', 'You Bao Jing', 'Wei Chu Li.');
